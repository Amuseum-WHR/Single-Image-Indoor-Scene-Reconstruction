...
class Tester():
    ...
    def to_device(self, data):
        ...
        # print(lo_ori_reg, lo_ori_cls, lo_centroid, lo_coeffs)
    ...
    def get_data_from_image(self, gpu, image_path, model_path, K, add_box=None, save_path=None):
        ...
        # [{"bbox": [1, 281, 198, 529], "class": "chair"}, {"bbox": [99, 210, 226, 393], "class": "chair"}, {"bbox": [135, 181, 220, 278], "class": "chair"}, {"bbox": [222, 154, 298, 254], "class": "chair"}, {"bbox": [231, 173, 297, 299], "class": "chair"}, {"bbox": [234, 198, 353, 392], "class": "chair"}, {"bbox": [271, 237, 464, 527], "class": "chair"}, {"bbox": [291, 147, 334, 195], "class": "chair"}, {"bbox": [319, 172, 381, 264], "class": "chair"}, {"bbox": [344, 137, 404, 174], "class": "chair"}, {"bbox": [352, 185, 462, 342], "class": "chair"}, {"bbox": [400, 160, 470, 256], "class": "chair"}, {"bbox": [452, 177, 549, 350], "class": "chair"}, {"bbox": [479, 154, 544, 241], "class": "chair"}, {"bbox": [522, 203, 708, 452], "class": "chair"}, {"bbox": [542, 175, 615, 212], "class": "chair"}, {"bbox": [614, 141, 702, 233], "class": "chair"}, {"bbox": [639, 202, 729, 421], "class": "chair"}]
        import json
